...
def main(
    ...
    # # Check environement with stable_baselines3
    ...
    agent_types = envs.get_attr("agent_types_list", indices=0)[0]

    agents = [
        A2C(i, agent_type, osp, asp)
        for i, (osp, agent_type, asp) in enumerate(zip(envs.observation_space, agent_types, envs.action_space))
    ]
    obs = envs.reset()
